...
document.addEventListener('DOMContentLoaded', () => {
  ...
  /* ===== 以下 parse / display / UI 交互 全部照搬 ===== */
  function parseKimiResponse(md) { /* 原逻辑 */ }
  function displayResults(d) { /* 原逻辑 */ }
  function drawRadar(data) { /* 原逻辑 */ }
